...
const ExperiencesPage = dynamic(() => import("@/components/experiences/ExperiencesPage"), { ssr: false });
...
export default function Page({ params }: { params: { hotelId: string } }) {
  ...
  return (
    <div className="trv-container" style={{ backgroundColor: theme.colors.backgroundLight }}>
      <ExperiencesPage hotelId={params.hotelId} />
    </div>
  );
}
