...
function WidgetChrome() {
  ...
  return (
    <div className="mx-auto max-w-5xl rounded-zacchera-container px-2 sm:px-4 py-4 sm:py-6 font-zacchera-body text-zacchera-base" style={{ backgroundColor: 'var(--trv-bg-light)', minHeight: '100%' }}>
      <Router />
    </div>
  );
}
